...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check_name(){
            ...
            //  异步校验资费名是否重复
            $.post("checkCostName",{"name":cost_name},function(data){
                    console.log(data);
                        //  回调函数的参数就是返回的info属性
                    var info = data;
                    //  根据返回值设置提示信息
...
<div id="main">
    ...
    <form action="addCost" method="post" class="main_form">
        ...
        <div class="input_info">
            <input type="text" class="width300" name="cost.name" value="" id="cost_name" onblur="check_name();"/>
        ...
        <div class="input_info">
            <input type="text" value="" name="cost.baseDuration" class="width100" />
        ...
        <div class="input_info">
            <input type="text" value="" name="cost.baseCost" class="width100" />
        ...
        <div class="input_info">
            <input type="text" value="" name="cost.unitCost" class="width100" />
