package com.fruit.web.weixin.api.core.util;
...
public class HttpRequestProxy {
	 ...
	 * @return HTTP响应的字符串
	 */
	public static String doJsonPost(String reqUrl, Map<String,String> parameters,
			String jsonData) {
		HttpURLConnection url_con = null;
		String responseContent = null;
		try {
	 ...
	 * @return
	 */
	public static String uploadMedia(String reqUrl, Map<String,String> parameters,
	...
	private static String getMapParamsToStr(Map<String,String> paramMap,String requestEncoding) throws IOException{
		StringBuffer params = new StringBuffer();
		// 设置边界
		for (Iterator<Entry<String,String>> iter = paramMap.entrySet().iterator(); iter
				.hasNext();) {
	 ...
	 * @return HTTP响应的字符串
	 */
	public static String downMadGet(String reqUrl, Map<String,String> parameters,
