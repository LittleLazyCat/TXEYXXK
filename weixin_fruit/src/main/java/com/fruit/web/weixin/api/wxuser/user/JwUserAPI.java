package com.fruit.web.weixin.api.wxuser.user;
...
import com.fruit.web.weixin.api.core.req.WeiXinReqService;
import com.fruit.web.weixin.api.core.req.model.user.UserBaseInfoGet;
import com.fruit.web.weixin.api.core.req.model.user.UserInfoListGet;
...
public class JwUserAPI {
	...
	public static Wxuser  getWxuser(String accesstoken,String user_openid) throws WexinReqException {
		if (accesstoken != null) {
			...
			if (error == null) {
				  wxuser = JSON.parseObject(result.toString(), Wxuser.class);//JSONObject.toBean(result, Wxuser.class);
			}
			return wxuser;
		}
		return null;
