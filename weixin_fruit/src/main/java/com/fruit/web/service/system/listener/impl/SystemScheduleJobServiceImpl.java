 ...
 */
@Service
public class SystemScheduleJobServiceImpl implements SystemScheduleJobService {
	
	private static final Logger log = Logger.getLogger(SystemScheduleJobServiceImpl.class);
