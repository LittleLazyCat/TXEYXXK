package com.fruit.core.persistence.convention.utils;
...
public class ReflectionUtils {
	 ...
	 * 
	* @Title. getPkObj
	* @Description. 根据属性类型做响应的转换
	* @param javaType
	* @param value
	* @return Object
	* @exception.
	 */
	public static Object getPkObj(Class<?> javaType,Object obj, String propertyName){
		String value = invokeGetterMethod(obj,propertyName);
		if(Long.class.getSimpleName().equals(javaType.getSimpleName())){
			return Long.valueOf(value);
		}else if(Short.class.getSimpleName().equals(javaType.getSimpleName())){
			return Short.valueOf(value);
		}else if(Integer.class.getSimpleName().equals(javaType.getSimpleName())){
			return Integer.valueOf(value);
		}else if(Double.class.getSimpleName().equals(javaType.getSimpleName())){
			return Double.valueOf(value);
		}else if(Float.class.getSimpleName().equals(javaType.getSimpleName())){
