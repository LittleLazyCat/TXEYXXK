package com.fruit.core.persistence.convention;
...
import com.fruit.core.persistence.convention.constant.OperateConstant;
import com.fruit.core.persistence.convention.db.SqlGenerator;
import com.fruit.core.persistence.convention.exception.ListIsNullException;
import com.fruit.core.persistence.convention.exception.PrimaryKeyNotFoundException;
import com.fruit.core.persistence.convention.id.UUIDHexGenerator;
import com.fruit.core.persistence.convention.utils.EntityUtil;
import com.fruit.core.persistence.convention.utils.ReflectionUtils;
import com.fruit.core.persistence.convention.utils.EntityUtil.EntityColumn;
import com.fruit.core.persistence.convention.utils.EntityUtil.EntityTable;
...
public class BaseDao <T, PK extends Serializable> implements IBaseDao<T, PK> {
	...
	*/
	...
	public PK create(T object) {
		...
		return (PK) ReflectionUtils.getPkObj(this.idJavaType,object,idName);
	}
