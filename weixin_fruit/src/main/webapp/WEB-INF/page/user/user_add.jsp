...
<body>
<div class="pd-20">
  <form action="${ctx }/system/user/addUser" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>用户名：</label>
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="" placeholder="" id="member-name" name="name" datatype="*" nullmsg="城市名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     	<div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="" placeholder="" id="member-name" name="password" datatype="*" nullmsg="密码不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="member-name" name="email">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/system/user/addUser", d, function (result) { 
