...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray"> 
		<span class="l"> <a class="btn btn-primary radius" href="javascript:;" onclick="add_user('添加用户','${ctx}/system/user/toAdd','700','300')" ><i class="Hui-iconfont">&#xe600;</i> 添加用户</a> </span>  </div>
		...
		<tbody>
			<c:forEach items="${data }" var="d">
				<tr class="text-c">
					...
					<td>${d.CREATE_DATE }</td>
					<td class="f-14">
						<a style="text-decoration:none" class="ml-5" onClick="change_role('设置角色','${ctx}/system/user/toRole/${d.ID }','700','400')" href="javascript:;" title="设置角色"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5"  href="${ctx }/system/user/delete/${d.ID}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
