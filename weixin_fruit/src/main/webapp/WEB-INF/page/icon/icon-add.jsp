...
<body>
<div class="pd-20">
	<form action="${ctx }/system/addicon" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			<label class="form-label col-3">名称：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="用户名不能为空" name="map['name']">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">ICON：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="用户名不能为空" name="map['code']">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
