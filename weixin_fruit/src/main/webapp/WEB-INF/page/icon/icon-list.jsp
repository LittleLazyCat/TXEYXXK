...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l">  <a class="btn btn-primary radius" href="javascript:;" onclick="addICON('添加图标','${ctx}/system/toAddicon','700','300')" ><i class="Hui-iconfont">&#xe600;</i> 录入</a>  </span>  
	</div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<c:forEach items="${data }" var="d">
				<tr class="text-c">
					...
					<td>${d.id }</td>
					<td>${d.name }</td>
					<td><i class="Hui-iconfont">${d.code }</i></td>
					<td>
							<a style="text-decoration:none" class="ml-5"  href="${ctx }/system/delicon/${d.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
			</c:forEach>
			</tbody>
...
function addICON(title,url,w,h){
