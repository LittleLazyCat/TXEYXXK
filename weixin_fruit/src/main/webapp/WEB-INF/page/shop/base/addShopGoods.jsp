	...
	<form action="" enctype="multipart/form-data" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="商品名称不能为空" name="title">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" name="realPrice">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">折扣：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" name="sale">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">快递名称：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" name="expressName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">快递费用：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" name="expressPrice">
			</div>
		</div>
		 <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" id="content" name="descriptions">
            </div>
        </div>
		<div class="row cl">
