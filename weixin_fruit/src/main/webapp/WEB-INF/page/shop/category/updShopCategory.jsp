	...
	<form action="" enctype="multipart/form-data" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${data.name }" placeholder="" id="" datatype="*" nullmsg="分类名称不能为空" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">录入顺序：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${data.sequence }" placeholder="" id="" name="sequence">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>图片上传：</label>
			<div class="formControls col-30"> 
				<img width="300" id="fileImg1" height="150" src="${ctx }/category_img/${data.imgurl }"/>
...
$(function(){
	...
	$("#form-article-add").Validform({
		...
		beforeSubmit:function(curform){
			curform.ajaxSubmit({
				type : "post",
				url : "${ctx }/weixinShopCategoryController/updCategory",
