...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l">  <a class="btn btn-primary radius" href="javascript:;" onclick="addComment('添加反馈意见','${ctx}/comment/toAddComment','700','300')" ><i class="Hui-iconfont">&#xe600;</i> 反馈意见</a> </span>  </div>
	<div class="mt-20">
