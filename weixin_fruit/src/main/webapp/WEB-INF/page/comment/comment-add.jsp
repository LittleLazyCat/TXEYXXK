...
<body>
<div class="pd-20">
	<form action="${ctx }/comment/addComment" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			<label class="form-label col-3">备注：</label>
			<div class="formControls col-5">
				<textarea name="comment" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" datatype="*" nullmsg="备注不能为空" onKeyUp="textarealength(this,100)"></textarea>
