				...
				<tbody>
					...
					<tr class="text-c va-m">
						...
						<td class="td-manage">
							...
							<a style="text-decoration:none" class="ml-5" onClick="edit_permission('修改权限','${ctx}/function/toUpdate/${d.id }','700','300')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
							</shiro:hasPermission>
							<shiro:hasPermission name="sys:permission:delete">
								<a style="text-decoration:none" class="ml-5"  href="${ctx}/function/delete/${d.id}/${d.pid}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</shiro:hasPermission>
						</td>
					</tr>
					</c:forEach>
...
$('.table-sort').dataTable({
	...
	"aoColumnDefs": [
	  {"orderable":false,"aTargets":[3],"visible": true}// 制定列不参与排序
	]
});
