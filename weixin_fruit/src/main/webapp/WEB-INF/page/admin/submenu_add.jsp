...
<body>
<div class="pd-20">
  <form action="${ctx }/permission/addSubMenu" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="" placeholder="" id="member-name" name="description" datatype="*" nullmsg="描述名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <input type="hidden" value="${pid }" name="pid">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="" placeholder="" id="member-name" name="url" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/permission/addSubMenu", d, function (result) { 
