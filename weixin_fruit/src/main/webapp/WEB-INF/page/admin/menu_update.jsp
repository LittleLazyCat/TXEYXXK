...
<body>
<div class="pd-20">
  <form action="${ctx }/permission/updateMenu" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>菜单名：</label>
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.name }" placeholder="" id="member-name" name="name" datatype="*" nullmsg="菜单不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
			<label class="form-label col-3">菜单图片：</label>
			<div class="formControls col-5"> <span class="select-box">
				<select name="icon" class="select">
				<c:forEach items="${ data2 }" var="d" >
					<option value="${d.code }" class="Hui-iconfont"><i>${d.code }--${d.name }</i></option>
				</c:forEach>
				</select>
				</span>
			</div>
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.desc }" placeholder="" id="member-name" name="desc" datatype="*" nullmsg="描述名不能为空">
      </div>
      <div class="col-4"> </div>
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.path }" placeholder="" id="member-name" name="path" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/permission/updateMenu", d, function (result) { 
