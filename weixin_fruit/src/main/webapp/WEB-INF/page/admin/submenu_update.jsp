...
<body>
<div class="pd-20">
  <form action="${ctx }/permission/updateSubMenu" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>菜单名：</label>
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${name }" placeholder="" id="member-name" name="name" datatype="*" nullmsg="菜单不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     	<div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${description }" placeholder="" id="member-name" name="description" datatype="*" nullmsg="描述名不能为空">
      </div>
      <div class="col-4"> </div>
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${url }" placeholder="" id="member-name" name="url" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/permission/updateSubMenu", d, function (result) { 
