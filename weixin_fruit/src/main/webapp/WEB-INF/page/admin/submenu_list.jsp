...
<div style="margin-left:150px;">
	...
	<div class="pd-20">
		<shiro:hasPermission name="sys:subperm:add"></shiro:hasPermission>
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a  class="btn btn-primary radius" href="javascript:;" onclick="add_submenu('添加子菜单','${ctx}/permission/toAddSubMenu/${pid }','700','300')"><i class="Hui-iconfont">&#xe600;</i> 添加子菜单</a></span></div>
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					...
					<tr class="text-c va-m">
						...
						<td>${d.DESCRIPTION }</td>
						<td class="f-14">
							<shiro:hasPermission name="sys:subperm:update"></shiro:hasPermission>
							<a style="text-decoration:none" class="ml-5" onClick="edit_submenu('编辑子菜单','${ctx}/permission/toEditSubMenu/${d.id }/${pid }','700','300')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
							
							<shiro:hasPermission name="sys:subperm:delete"></shiro:hasPermission>
							<a style="text-decoration:none" class="ml-5"  href="${ctx }/permission/delsubmenu/${d.id}/${d.pid}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
...
$(document).ready(function(){
	$.post('${ctx}/permission/tree/${pid}',function(data){
		var t = $("#treeDemo");
