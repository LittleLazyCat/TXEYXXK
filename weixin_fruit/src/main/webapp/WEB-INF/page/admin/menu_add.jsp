...
<body>
<div class="pd-20">
  <form action="${ctx }/permission/addMenu" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="" placeholder="" id="member-name" name="path" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/permission/addMenu", d, function (result) { 
