...
<div class="pd-20">
  <form action="#" method="post" class="form form-horizontal" id="form-member-add">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.name }" placehaolder="" id="member-name" name="name" datatype="*" nullmsg="菜单不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.permCode }" placeholder="" id="member-name" name="code" >
      </div>
      <div class="col-4"> </div>
    </div>
     	<div class="row cl">
      ...
      <div class="formControls col-5">
     	<input type="text" class="input-text" value="${data.description }" placeholder="" id="member-name" name="desc" datatype="*" nullmsg="描述名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
...
$(function(){
	$("#save").click(function() {
        ...
        $.post("${ctx }/function/update", d, function (result) { 
