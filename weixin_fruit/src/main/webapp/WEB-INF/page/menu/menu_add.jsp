...
<body>
<div class="pd-20">
  <form action="${ctx }/menuManagerController/addMenu" method="post" class="form form-horizontal" id="form-member-add">
   <div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>菜单名称：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text"  value="" placeholder="" id="" datatype="*" nullmsg="菜单名称不能为空" name="name">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5"> <span class="select-box">
				<select name="fatherId" class="select">
		...
		<div class="row cl">
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="URL不能为空" name="url">
			</div>
			<div class="col-4"> </div>
		</div>
		 <div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="标识不能为空" name="menuKey">
			</div>
			<div class="col-4"> </div>
		</div>
		 <div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="" datatype="*" nullmsg="顺序不能为空" name="orders">
			</div>
			<div class="col-4"> </div>
		</div>
    <div class="row cl">
