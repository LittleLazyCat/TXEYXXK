...
<div class="pd-20" style="padding-top:20px;">
  <p class="f-20 text-success">欢迎使用微信管理系统 <span class="f-14">v2.3</span></p>
  <p>登录次数：${count }&nbsp;&nbsp; 您共登录系统：${refCount} 次&nbsp;&nbsp;当前在线人数：<span id="count"></span>  </p>
...
$(document).ready(function(){  
	 setInterval(getnums, 9000);  
}); 
getnums();
function getnums() {  
	$.get("${ctx}/online/index",function(data){
