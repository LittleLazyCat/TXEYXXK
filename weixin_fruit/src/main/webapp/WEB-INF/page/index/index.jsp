...
<![endif]-->
<title>微信管理系统 v2.3</title>
<meta name="keywords" content="H-ui.admin v2.3,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v2.3，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="${ctx }/resources/skin/">微信管理系统</a> <a class="Hui-logo-m l" href="${ctx }/resources/skin/" title="H-ui.admin"></a> <span class="Hui-subtitle l">V2.3</span>
	<ul class="Hui-userbar">
		...
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">${UserUtil.getCurrentUser().getName() } <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="javascript:;" onclick="forget('修改密码','${ctx }/system/forget','1','500','400')" href="">修改密码</a></li>
				<li><a href="${ctx }/system/logout">切换账户</a></li>
				<li><a href="${ctx }/system/logout">退出</a></li>
			</ul>
		</li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${ctx }/system/welcome"></iframe>
		</div>
	</div>
</section>
