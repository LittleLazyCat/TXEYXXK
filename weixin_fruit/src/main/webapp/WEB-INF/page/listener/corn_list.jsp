...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" href="javascript:;" onclick="add('添加表达式','${ctx }/systemCornController/toAddCorn','500','300')" ><i class="Hui-iconfont">&#xe600;</i> 添加表达式</a></span>  </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr>
				<th scope="col" colspan="4">表达式管理</th>
			</tr>
			<tr class="text-c">
				<th width="90">ID</th>
				<th width="100">表达式</th>
		...
		<tbody>
			<c:forEach items="${data }" var="d">
				<tr class="text-c">
					...
					<td>${d.name }</td>
					<td class="f-14">
						<a style="text-decoration:none" class="ml-5"  href="${ctx }/systemCornController/delCorn/${d.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
