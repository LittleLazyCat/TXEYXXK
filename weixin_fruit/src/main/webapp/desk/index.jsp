...
<title>首页</title>
<link rel="stylesheet" href="${ctx }/static/css/common.css" type="text/css" media="all" />
<link rel="stylesheet" href="${ctx }/static/css/index.css" type="text/css" media="all" />
<script type="text/javascript" src="${ctx }/static/js/jquery.js"></script>
<script type="text/javascript" src="${ctx }/static/js/fadebanner.js"></script>
<!--[if IE 8]> 
  <style type="text/css">
...
<body bgcolor="#e0d6df">
  <div id="header">
    <div class="online-service">
      <p><img src="${ctx }/static/img/ico-online-service.gif" width="71" height="28" alt="在线客服" /></p>
    ...
    <div class="logo-container"><img src="${ctx }/static/img/logo-fujia.png" width="197" height="51" alt="logo" /></div>
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <div class="product-show">
        ...
        <ul class="show-list">
          <li>
            <p><a href="javascript:;"><img src="${ctx }/static/img/index/img-tmall.gif" alt="合作伙伴" width="136" height="137" /></a></p>
          </li>
          <li>
            <p><a href="javascript:;"><img src="${ctx }/static/img/index/img-tmall.gif" alt="合作伙伴" width="136" height="137" /></a></p>
          </li>
